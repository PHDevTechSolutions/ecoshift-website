      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="relative pt-52 pb-40 bg-secondary/30 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
            ...
            >
              Get Your <br /> Free{" "}
              <span className="text-emerald-700 italic">Quote</span>
            </motion.h1>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg font-medium leading-relaxed">
              Request a free lighting consultation and quote tailored to your
              project. Our experts will review your requirements and provide a
              customized solution.
            </p>
          </div>
        </section>
        ...
        <section className="relative z-20 -mt-24 px-6 pb-24">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              {/* Right: Advanced Form with Old Form Styling */}
                  ...
                  {status === "success" ? (
                    <div className="p-10 text-center space-y-6">
                      ...
                      <button
                        ...
                        className="text-[#d11a2a] text-[10px] font-black uppercase tracking-widest pt-4 hover:underline"
                      >
                        Send Another Quote
                      </button>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            placeholder="John"
                            className="w-full bg-secondary/50 border border-border rounded-2xl px-6 py-4 outline-none focus:ring-2 focus:ring-emerald-700/20 transition-all font-bold"
                          />
                        </div>
                        <div className="space-y-2">
                          <label className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          placeholder="123 Tech Avenue, Business District"
                          className="w-full bg-secondary/50 border border-border rounded-2xl px-6 py-4 outline-none focus:ring-2 focus:ring-emerald-700/20 transition-all font-bold"
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          className="w-full h-32 bg-secondary/50 border border-border rounded-2xl px-6 py-4 outline-none focus:ring-2 focus:ring-emerald-700/20 transition-all font-bold resize-none"
                        />
                      </div>

                      <div className="space-y-4">
                        <label className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">
                          Project Plans / Brief (Upload File)
                        </label>
                        <div
                          onClick={() => fileInputRef.current?.click()}
                          className={`border-2 border-dashed rounded-4xl p-10 flex flex-col items-center cursor-pointer transition-all 
                            ${
                              file
                                ? "border-emerald-700 bg-emerald-50"
                                : "border-gray-200 hover:border-emerald-700 hover:bg-emerald-50"
                            }`}
                        >
                          <input
                            type="file"
                          ...
                          <div className="w-14 h-14 rounded-2xl bg-gray-50 flex items-center justify-center mb-4">
                            {loading ? (
                              ...
                              <Upload
                                className={
                                  file ? "text-emerald-700" : "text-gray-400"
                                }
                              />
                            )}
                          </div>
                          <p className="text-sm font-bold text-gray-900 uppercase tracking-tight">
                            {file ? file.name : "Click to browse project files"}
                          </p>
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="w-full py-5 rounded-2xl font-black uppercase tracking-[0.3em] text-xs shadow-lg flex items-center justify-center gap-4 bg-emerald-700 text-white transition-all disabled:opacity-50"
                      >
                        {loading ? (
                          <>
                            Processing{" "}
